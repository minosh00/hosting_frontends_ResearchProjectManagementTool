...
const Allocatepanelmembers = () => {
  ...
  const UpdateData = async (e) => {
    ...
    if (!data?.data?.GruopLeaderEmail) {
      {   Swal.fire('success' , 'Assign pannelmember   successfully ' , 'success')
    ...
    <div className="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
      <center>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="floatingInput"  readOnly={true}    value={GruopLeaderItNumber}   onChange={handleGruopLeaderItNumber}  required placeholder="" />
          <input type="text" class="form-control" id="floatingInput"  readOnly={true}    value={GruopLeaderEmail}   onChange={handleGruopLeaderEmail}  required placeholder="" />

          <input type="text" class="form-control" id="floatingInput"  readOnly={true}    value={GruopMembersItNumbers}   onChange={handleGruopMembersItNumbers}  required placeholder="" />

          <input type="text" class="form-control" id="floatingInput"  readOnly={true}    value={GruopMembersNames}   onChange={handleGruopMembersNames}  required placeholder="" />

          <input type="text" class="form-control" id="floatingInput"  readOnly={true}    value={GruopMembersEmail}   onChange={handlesetGruopMembersEmail}  required placeholder="" />

          <input type="text" class="form-control" id="floatingInput"  readOnly={true}    value={GruopMembersContectNumber}   onChange={handlesetGruopMembersContectNumber}  required placeholder="" />
          <input type="text" class="form-control" id="floatingInput"  readOnly={true}    value={GroupID}   onChange={handleGroupID}  required placeholder="" />
